...
public interface FornecedorDAO extends JpaRepository<FornecedorEntity, Long> {
	...
	@Transactional
	@Modifying
	@Query("UPDATE FornecedorEntity f SET f.nomeFantasia =:nomeFantasia, f.razaoSocial =:razaoSocial,"
	...
	void editar(@Param("nomeFantasia") String nomeFantasia, @Param("razaoSocial") String razaoSocial,
			@Param("cnpj") String cnpj, @Param("inscricaoEstadual") String inscricaoEstadual,
			@Param("endereco") String endereco, @Param("bairro") String bairro, @Param("cidade") String cidade,
			@Param("uf") String uf, @Param("cep") String cep, @Param("telefone") String telefone,
			@Param("celular") String celular, @Param("email") String email, @Param("nomeContato") String nomeContato,
